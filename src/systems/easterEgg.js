	...
	"奥特曼": [
		{
			...
			triggerDescription: "佐菲与奥特之王同时登场时触发。",
		...
		},
		{
			...
			characters: ["杰克", "赛文"],
			triggerType: "gameStart",
			triggerDescription: "杰克与赛文同时登场时触发。",
			hint: "有位奥特曼认错了人。",
			content: ["谢谢你泰罗"],
		},
		{
	...
	"原神": [
		{
			...
			characters: ["玛薇卡", "希诺宁"],
			triggerType: "gameStart",
			triggerDescription: "玛薇卡与希诺宁同时登场时触发。",
		...
		},
		{
			...
			characters: ["恰斯卡", "希诺宁"],
			triggerType: "gameStart",
			triggerDescription: "恰斯卡与希诺宁同时登场时触发。",
		...
		},
		{
			...
			characters: ["芙宁娜", "阿蕾奇诺"],
			triggerType: "gameStart",
			triggerDescription: "芙宁娜与阿蕾奇诺同时登场时触发。",
	...
	"崩坏：星穹铁道": [
		{
			...
			characters: ["黄泉"],
			triggerType: "gameStart",
			triggerDescription: "开局黄泉登场时，有概率触发。",
			hint: "一位角色迷路了。",
			content: ["迷路了..."],
		},
		{
			...
			characters: ["黄泉"],
			triggerType: "recover",
			triggerDescription: "黄泉使用【桃】回复体力时，有概率触发。",
			hint: "她爱吃桃子。",
			content: ["🍑"],
		},
	],
	"东方project": [
		{
			...
			characters: ["曼波", "琪露诺"],
			triggerType: "gameStart",
			triggerDescription: "曼波与琪露诺同时登场时触发。",
			hint: "武将pr要交给谁审核呢。",
